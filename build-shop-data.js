...
for (const row of totalsRows) {
    ...
    creatorsMap[key] = {
        ...
        levelLabel:   getVal(row, 'Level Label') || '--',
        productRank:  cleanRank(getVal(row, 'Rank Label')),
        cashBonus:    toNum(getVal(row, 'Cash Bonus') || getVal(row, 'Bonus')),
        tapLM:        toNum(getVal(row, 'TAP Total LQ')),
        tapGoalM:     toNum(getVal(row, 'TAP Goal M')),
        tapLQ:        toNum(getVal(row, 'TAP Total LQ')),
        tapGoalQ:     toNum(getVal(row, 'TAP Goal Q')),
        tapTotalTQ:   toNum(getVal(row, 'TAP Total TQ')),
        ...
        tapYTD:       toNum(getVal(row, 'TAP Total TQ')),
